	...
	function insertTimes(id){
		...
		if ($('#date').val().substring(5,6)!="0") {
			var screeningday = y+"0"+$('#date').html().substring(5,6)+$('#date').html().substring(7,9);
		}else{
			var screeningday = y+$('#date').html().substring(5,7)+$('#date').html().substring(8,10);
		}
		//alert(screeningday);
