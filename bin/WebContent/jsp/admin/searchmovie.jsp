		...
		<table border="0" align="center">
			...
			<tr style="height:150px;">
				...
				<td style="width:100px;">
					<div id="choiceMoive">
						<input type="radio" value="1" class="movieRadio" name="movieRadio">1관<br>
						<input type="radio" value="2" class="movieRadio" name="movieRadio">2관<br>
						<input type="radio" value="3" class="movieRadio" name="movieRadio">3관<br>
						<input type="radio" value="4" class="movieRadio" name="movieRadio">4관<br>
						<input type="radio" value="5" class="movieRadio" name="movieRadio">5관<br>
					</div>
				</td>
			</tr>
		</table>
