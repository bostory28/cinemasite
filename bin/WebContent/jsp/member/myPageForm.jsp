...
<script type="text/javascript">
	/*예매취소 확인*/
	function cancleReservation(no){
		if (!confirm('예매를 취소하시겠습니까?')) {
			return false;
		}
		location.href="cancleReservation.action?reservationno="+no;
	}
</script>
</head>
<body>
	...
	<table align="center">
		<tr>
			<td>
				<div align="center"
					style="font-size: 45px; font-weight: bold; font-family: 'Nanum Gothic'; color: crimson">마이페이지</div>
				<s:form name="myPageform" action="goPass_cnfForm.action"
					method="post" theme="simple">
					<h3 style="font-family: 'Nanum Gothic';font-weight: bold">내 정보</h3>
					<div style="background-color: #f3dcb3; width: 850px">
						<table 
		...
		<tr>
			...
			<h3 style="font-family: 'Nanum Gothic';font-weight: bold">나의 예매정보</h3>
				<div
					style="background-color: #f3dcb3; width: 850px; font-family: 'Nanum Gothic';">
								...
								<tr>
									...
									<td align="center">
										<input type="button" style="font-family: 'Nanum Gothic';" onClick="cancleReservation('<s:property
													value="reservelist[#status1.index].reservationno" />');"
