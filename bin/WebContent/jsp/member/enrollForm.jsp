...
<jsp:include page="../include/header.jsp"/>
	...
	<table align="center">
		<tr>
			<td>
				<div align="center"
					style="font-size: 45px; font-weight: bold; font-family: 'Nanum Gothic'; color: crimson">회원가입</div>
				<p style="vertical-align: sub; font-size: 14px ; font-family: 'Nanum Gothic'">정확하게 기재해 주세요</p> <s:form
					name="enrollform" action="enrollMember" method="post"
					theme="simple" onsubmit="return formCheck();">
					<div style="background-color: #f3dcb3;">
						...
						<table style="margin: 30px 20px 20px 20px;font-family: 'Nanum Gothic'">
							...
							<tr>
								<td class="title">이름
								<td class="content"><s:textfield name="membervo.name" id="name" placeholder="이름" />
							</tr>
							<tr>
								<td class="title">생년월일
								<td class="content"><input type="hidden" id="birthday">
