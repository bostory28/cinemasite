	...
	<table align="center" style="width: 1024px;">
		<tr>
			...
			<h3>회원정보수정</h3><br>
				...
				<s:form name="modifyMemberform" action="modifyMember" method="post" theme="simple" onsubmit="return formCheck();">
					<div style="background-color: #FFF; font-family: 'Nanum Gothic';" align="center">
						...
						<table style="margin: 30px 20px 20px 20px;">
							<tr>
								...
								<td class="membercontent"><s:textfield name="membervo.userid" id="id"
										value="%{membervo.userid }" readonly="true" />
							<br>
							<tr>
								<td class="membertitle">이름
								<td class="membercontent"><s:textfield name="membervo.name" id="name" value="%{membervo.name }" />
							</tr>
							<tr>
								<td class="membertitle">비밀번호
								<td class="membercontent"><s:password name="membervo.password"
										id="password" />
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="membercontent"><input type="hidden"
							...
							<tr>
								...
								<td class="membercontent"><input type="hidden"  id="sex">
									...
									<input type="radio" name="membervo.sex" value="여자">여자
										...
										<input type="radio" name="membervo.sex" value="남자">남자
									<input type="radio" name="membervo.sex" value="여자" checked="checked">여자
										</s:if>
							</tr>
							<tr>
