...
<div id="page" align="center">
	<div id="content">
		<table border="0" align="center" style="background-color: white;">
			<tr>
				<td>
					<div class="cont"><table id="day"></table></div>
				</td>
				<td style="width:824px;" align="center">
					<div class="cont">
						<table border="0" style="height:750px;">
							<tr>
								<td colspan="2">
									<div><s:textfield name="date" id="date" theme="simple" style="border-width: 0;"/></div>
								</td>
							</tr>
							<tr>
								...
								<td>
									<s:textfield id="title1Seq" readOnly="true" size="5" theme="simple" value="영화번호"/>
							...
							<tr>
								<td colspan="3">
									<input type="text" size="10" value="1회차" class="bg" readOnly="true">
									<input type="text" size="10" value="2회차" class="bg" readOnly="true">
									<input type="text" size="10" value="3회차" class="bg" readOnly="true">
									<input type="text" size="10" value="4회차" class="bg" readOnly="true">
									<input type="text" size="10" value="5회차" class="bg" readOnly="true">
									<input type="text" size="10" value="6회차" class="bg" readOnly="true">
									<input type="text" size="10" value="7회차" class="bg" readOnly="true">
								</td>
							</tr>
							<tr>
								<td colspan="3">
							...
							<tr>
								...
								<td align="left">
									<s:textfield id="title2Seq" readOnly="true" size="5" theme="simple" value="영화번호"/>
...
<!-- 									<a href="#" onclick="searchMovie()">영화검색</a> -->
							...
							<tr>
								...
								<td align="left">
									<s:textfield id="title3Seq" readOnly="true" size="5" theme="simple" value="영화번호"/>
...
<!-- 									<a href="#" onclick="searchMovie()">영화검색</a> -->
							...
							<tr>
								...
								<td align="left">
									<s:textfield id="title4Seq" readOnly="true" size="5" theme="simple" value="영화번호"/>
...
<!-- 									<a href="#" onclick="searchMovie()">영화검색</a> -->
							...
							<tr>
								...
								<td align="left">
									<s:textfield id="title5Seq" readOnly="true" size="5" theme="simple" value="영화번호"/>
...
<!-- 									<a href="#" onclick="searchMovie()">영화검색</a> -->
				...
				<td style="width:80px;margin-top: 100px;" align="center" class="cont">
