...
<script type="text/javascript">
	$(document).ready(function() {
		...
		function outputTable(data) {
			var table = '<table style="font-size: 20px; border-collapse: collapse;background-color: white;">';
...
<br>
	<div style="width: 100%; text-align: center;">
		<div style="width: 1024px; font-size: 30px; font-weight: bold; margin: 0 auto;">
			...
			<div><br></div>
			<div style="border: 5px solid #A6A6A6; margin: 0 auto; border-radius:10px; width: 1024px; text-align: center; padding-top: 50px; padding-bottom: 50px; background-color: white;">
			...
			<div>
				<input type="button" value="마이페이지" onclick="location.href='<%=request.getContextPath()%>/member/goMyPageForm.action';">
				<input type="button" value="홈으로" onclick="location.href='<%=request.getContextPath()%>/index.action';">
			</div>
		</div>
		<br><br>
